...
{
    public class TodoMasterDetailController : Controller
    {
        private readonly ApplicationDbContext _context;

        public TodoMasterDetailController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: TodoMasterDetail
        public async Task<IActionResult> Index()
        {
            return View(await _context.Todo.ToListAsync());
        }

        // GET: TodoMasterDetail/Details/5
        ...
        // GET: TodoMasterDetail/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TodoMasterDetail/Create
        ...
        // POST: TodoMasterDetail/Delete/5
